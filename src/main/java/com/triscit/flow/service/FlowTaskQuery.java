 ...
 * @Date 2022/4/5 15:26
 */
public interface FlowTaskQuery {
    /**
     * 创建流程任务查询对象
     *
     ...
     */
    List<Task> taskCandidateUser(String userId, int start, int limit);
     ...
     * @return List<Task>  流程任务列表.
     */
    List<Task> taskAssignee(String userId, int start, int limit);
     ...
     */
    List<Task> taskCandidateUserByCondition(String userId, Map<String, Object> variables, int start, int limit);
     ...
     * @return List<Task>  分页流程任务列表.
     */
    List<Task> taskAssigneeByCondition(String userId, Map<String, Object> variables, int start, int limit);
     ...
     * @return List<Task>  分页流程任务列表.
     */
    List<Task> taskCandidateOrAssignedByCondition(String userId, Map<String, Object> variables, int start, int limit);
     ...
     */
    List<HistoricTaskInstance> taskAssigneeHistory(String userId, int start, int limit);
     ...
     * @return List<Task>  历史流程任务列表.
     */
    List<Task> taskAssigneeByTaskQuery(String assignee, TaskQuery query, int start, int limit);
