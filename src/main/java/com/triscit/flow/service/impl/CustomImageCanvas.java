 ...
 * @Date 2022/4/5 16:20
 */
public class CustomImageCanvas {

    protected static final Logger LOGGER = LoggerFactory.getLogger(CustomImageCanvas.class);
     ...
     */
    public CustomImageCanvas(int width, int height, int minX, int minY, String imageType, String activityFontName, String labelFontName, ClassLoader customClassLoader) {
     ...
     */
    public CustomImageCanvas(int width, int height, int minX, int minY, String imageType) {
        this.canvasWidth = width;
        this.canvasHeight = height;
        this.minX = minX;
        this.minY = minY;
