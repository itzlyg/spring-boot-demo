 ...
 * @Date 2022/4/5 16:22
 */
public class CustomImageGenerator implements ProcessDiagramGenerator {
    protected static final Logger logger = LoggerFactory.getLogger(CustomImageGenerator.class);
    ...
    public CustomImageGenerator() {
        this(1.0);
    }

    // The instructions on how to draw a certain construct is
    // created statically and stored in a map for performance.
    public CustomImageGenerator(final double scaleFactor) {
        // start event
    ...
    protected CustomImageCanvas generateProcessDiagram(BpmnModel bpmnModel, String imageType,
        ...
        CustomImageCanvas processDiagramCanvas = initProcessDiagramCanvas(bpmnModel, imageType,
     ...
     * @author Fuxs
     */
    protected void drawActivity(CustomImageCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode,
                                List<String> highLightedActivities, List<String> runningActivitiIdList, List<String> highLightedFlows,
                                double scaleFactor) {
...
//				}
     ...
     * @return
     */
    protected static List<GraphicInfo> connectionPerfectionizer(CustomImageCanvas processDiagramCanvas,
        ...
        CustomImageCanvas.SHAPE_TYPE sourceShapeType = getShapeType(sourceElement);
        CustomImageCanvas.SHAPE_TYPE targetShapeType = getShapeType(targetElement);
     ...
     */
    protected static CustomImageCanvas.SHAPE_TYPE getShapeType(BaseElement baseElement) {
        if (baseElement instanceof Task || baseElement instanceof Activity || baseElement instanceof TextAnnotation) {
            return CustomImageCanvas.SHAPE_TYPE.Rectangle;
        } else if (baseElement instanceof Gateway) {
            return CustomImageCanvas.SHAPE_TYPE.Rhombus;
        } else if (baseElement instanceof Event) {
            return CustomImageCanvas.SHAPE_TYPE.Ellipse;
        } else {
    ...
    protected void drawArtifact(CustomImageCanvas processDiagramCanvas, BpmnModel bpmnModel,
                                Artifact artifact) {
    ...
    private static void drawHighLight(CustomImageCanvas processDiagramCanvas, GraphicInfo graphicInfo) {
     ...
     * @author Fuxs
     */
    private static void drawRunningActivitiHighLight(CustomImageCanvas processDiagramCanvas, GraphicInfo graphicInfo) {
        processDiagramCanvas.drawRunningActivitiHighLight((int) graphicInfo.getX(), (int) graphicInfo.getY(), (int) graphicInfo
                .getWidth(), (int) graphicInfo.getHeight());

    }

    protected static CustomImageCanvas initProcessDiagramCanvas(BpmnModel bpmnModel, String imageType,
        ...
        return new CustomImageCanvas((int) maxX + 10, (int) maxY + 10, (int) minX, (int) minY, imageType,
                activityFontName, labelFontName, customClassLoader);
    }
    ...
    protected interface ActivityDrawInstruction {
        ...
        void draw(CustomImageCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode);
    }

    protected interface ArtifactDrawInstruction {

        void draw(CustomImageCanvas processDiagramCanvas, BpmnModel bpmnModel, Artifact artifact);
    }
