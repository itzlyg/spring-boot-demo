...
import com.triscit.flow.context.VariablesEnum;
...
public class FlowTaskQueryImpl extends ServiceFactory implements FlowTaskQuery {

    protected static Logger logger = LoggerFactory.getLogger(FlowTaskQueryImpl.class);
    ...
    public TaskVo queryTaskVOById(String taskId) {
        ...
        return PojoUtil.copyBean(task, TaskVo.class);
    }
